  ...
  <div class="profileContainer">
    ...
    <div class="profile-left">
      <div class="profile-img-wrap story-border" onclick="popup('.modal-image')">
        ...
        <img src="/upload/${userInfo.profileImage}" alt=""  onerror="this.src='/images/common.jpg'" id="profile-image-url"/>
    ...
    <div class="profile-right">
      <div class="name-group">
        ...
        <c:choose>
          <c:when test="${principal.userId == userInfo.userId}">
          ...
          <c:otherwise>
            <c:choose>
              <c:when test="${dto.followState}">
                <button class="cta blue" onclick="followOrUnFollowProfile(${userInfo.userId})"  id="follow_profile_btn">구독취소</button>
              </c:when>
              <c:otherwise>
                <button class="cta" onclick="followOrUnFollowProfile(${userInfo.userId})" id="follow_profile_btn">구독하기</button>
              </c:otherwise>
            </c:choose>
